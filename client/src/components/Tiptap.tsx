...
export default function Tiptap({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "font-source flex-1 leading-7 [&:not(:first-child)]:mt-6 text-lg sm:text-xl px-4 sm:px-6 py-4 border-none dark:text-white rounded-md border focus-within:outline-none",
      },
    },
    onUpdate({ editor }) {
